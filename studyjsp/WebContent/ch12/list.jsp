...
List<BoardDataBean> articleList = null;//글목록을 저장 검색 기능 쓸대 
//list page기능할때 테이블에 들어있는 전체 데이터수를 가져와야함
...
try{
  if(count > 0)//테이블에 저장된 글이 있으면, 테이블에서 글목록을 가져옴 아무것도 없으면 가져오는의미가없기에 0보다이상
...
<div id="list_head" class="box2">
   ...
   <button id="new">글쓰기</button> <!-- list .js  -->
</div>
