...
<%
 ...
 article.setReg_date(new Timestamp(System.currentTimeMillis()) );//날짜처리 사용자가 입력해주지앟는것은 set으로 작성해서 처리해야됨
 article.setIp(request.getRemoteAddr());//사용자가 썻던 pc ip 받아올수있는 명령어 
